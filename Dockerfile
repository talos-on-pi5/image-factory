...
#
# Generated on 2025-01-18T06:35:45Z by kres 3b3f992.

ARG TOOLCHAIN

FROM alpine:3.21.3 AS base-image-image-factory

# runs markdownlint
FROM docker.io/oven/bun:1.2.8-alpine AS lint-markdown
WORKDIR /src
...
COPY --from=ghcr.io/siderolabs/installer:v1.9.5 /usr/share/grub/unicode.pf2 /usr/share/grub/unicode.pf2
